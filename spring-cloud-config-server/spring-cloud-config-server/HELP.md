...
* The original package name 'com.cts.training.spring-cloud-config-server' is invalid and this project uses 'com.cts.training.springcloudconfigserver' instead.
