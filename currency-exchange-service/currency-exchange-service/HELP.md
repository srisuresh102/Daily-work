...
* The original package name 'com.cts.training.currency-exchange-service' is invalid and this project uses 'com.cts.training.currencyexchangeservice' instead.
